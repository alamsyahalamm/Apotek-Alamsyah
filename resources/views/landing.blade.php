        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">Beli Obat Ga Harus Pergi Keluar</h1>
                    <hr class="divider"/>
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">Sekarang anda dapat membeli kebutuhan Obat tanpa harus pergi ke toko Apotek
                        offline loh.</p>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="text-dark-75 mb-4">
                        Sistem Apotek Alamsyah adalah aplikasi web yang dibuat dengan framework Laravel. Aplikasi website
                        Ini berfokus pada penjualan Obat. Website ini diciptakan untuk memperluas pasar penjualan di bidang
                        digital.
                    </p>
            ...
            <div class="row gx-4 gx-lg-5 bg-white pb-5 rounded">
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <p class="text-muted mb-0">GaleriTugas@gmail.com</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <p class="text-muted mb-0">+62 823 4634 5505</p>
                    </div>
                </div>
            </div>
        </div>
