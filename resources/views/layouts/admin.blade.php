            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ url('admin/dashboard') }}">Apotek Alamsyah</a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown {{ Route::currentRouteName() == 'obat' ? 'active' : '' }}">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
                                    class="fas fa-columns"></i> <span>Obat</span></a>
                            <ul class="dropdown-menu">
                                <li class="{{ Request::is('admin/tambah-obat') ? 'active' : '' }}"><a class="nav-link"
                                        href="{{ url('admin/tambah-obat') }}">Tambah obat</a>
                                </li>
                                <li class="{{ Route::currentRouteName() == 'obat' ? 'active' : '' }}"><a
                                        class="nav-link" href="{{ url('admin/obat') }}">List
                                        Obat</a></li>
                            </ul>
                        </li>
