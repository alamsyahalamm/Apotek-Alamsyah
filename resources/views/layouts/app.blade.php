...
<body>
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm sticky-top navbar-expand-lg " role="navigation">
                    ...
                    @else
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{ url('member/history') }}">
                                    Riwayat Pemesanan
                                </a>
