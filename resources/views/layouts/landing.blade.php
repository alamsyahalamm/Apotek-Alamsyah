...
<body id="page-top">
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                @else
                    ...
                    <li class="btn btn-primary btn-sm rounded-pill"><a class="nav-link text-white" href="/login">Login</a>
                    </li>
                @endauth
            </div>
        </div>
    ...
    <footer class="bg-light py-5">
        <div class="container px-4 px-lg-5">
            <div class="small text-center text-muted">Copyright &copy; 2022 - Galeri Tugas</div>
        </div>
    </footer>
